...
const VerticalCard = ({loading, data = []}) => {
    ...
    return (
        <div className={`grid grid-cols-[repeat(auto-fit,minmax(300px,320px))] ${data.length > 4 ? 'justify-between' : 'justify-start'} md:gap-6 overflow-scroll scrollbar-none transition-all`}>
            {
